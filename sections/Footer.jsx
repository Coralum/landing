        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-10 h-10 bg-gradient-to-r from-coralum-orange to-coralum-coral rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-lg">C</span>
              </div>
              <div>
                <h3 className="text-2xl font-bold text-white">Coralum</h3>
                <p className="text-coralum-coral text-sm font-medium">Software as a Reef</p>
              </div>
            </div>
            ...
            <ul className="space-y-3">
              {footerLinks.map((link) => (
                <li key={link.label}>
                  <a 
                    href={link.href}
                    className="text-gray-300 hover:text-coralum-coral transition-colors duration-300 flex items-center group"
                  >
                    {link.label}
          ...
          <div>
            ...
            <a 
              ...
              className="inline-flex items-center text-coralum-coral hover:text-coralum-orange font-semibold transition-colors duration-300"
            >
        ...
        <div className="border-t border-gray-600 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex space-x-6">
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-coralum-coral transition-colors duration-300"
            >
