      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          ...
          >
            <Button 
              size="lg"
              className="bg-[#fe5620] hover:bg-[#e5491c] text-white px-6 sm:px-8 lg:px-10 py-4 sm:py-6 text-base sm:text-lg lg:text-xl font-semibold rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-105 w-full sm:w-auto"
              onClick={() => {
